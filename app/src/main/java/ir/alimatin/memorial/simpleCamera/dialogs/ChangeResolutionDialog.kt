package ir.alimatin.memorial.simpleCamera.dialogs
...
class ChangeResolutionDialog(val activity: BaseSimpleActivity, val isFrontCamera: Boolean, val photoResolutions: ArrayList<MySize>,
