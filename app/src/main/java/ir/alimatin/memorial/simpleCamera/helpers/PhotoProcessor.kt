package ir.alimatin.memorial.simpleCamera.helpers
...
class PhotoProcessor(val activity: CameraActivity, val saveUri: Uri?, val deviceOrientation: Int, val previewRotation: Int, val isUsingFrontCamera: Boolean,
