package ir.alimatin.memorial.simpleCamera.views
...
import ir.alimatin.memorial.simpleCamera.dialogs.ChangeResolutionDialog
import ir.alimatin.memorial.simpleCamera.extensions.config
import ir.alimatin.memorial.simpleCamera.extensions.getOutputMediaFile
...
import ir.alimatin.memorial.simpleCamera.models.FocusArea
import ir.alimatin.memorial.simpleCamera.models.MySize
import java.io.File
import java.util.*
...
class CameraPreview : ViewGroup, TextureView.SurfaceTextureListener, MyPreview {
    ...
    constructor(activity: CameraActivity, textureView: AutoFitTextureView, initPhotoMode: Boolean) : super(activity) {
        mActivity = activity
