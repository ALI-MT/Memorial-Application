package customView.spinnerloading;
...
import customView.spinnerloading.Animation.CallbackAnimation;
import customView.spinnerloading.utils.SpinnerLoadingUtils;
...
public class SpinnerLoading extends View implements CallbackAnimation.TransformationListener {
    ...
    public static final int DEFAULT_itemCount = 4;
    public static final int DEFAULT_CIRCLE_COLOR = 0xffffffff;
    public static final int DEFAULT_CIRCLE_COLOR_MOVE = 0xffffffff;
    public static final float DEFAULT_SCALE_RATE = 0.2f;
    public static final int DEFAULT_RADIUS = 6;
    public static final int DEFAULT_WIDTH_FACTOR = 6;
    public static final int DEFAULT_WIDTH_PADDING_FACTOR = 1;
